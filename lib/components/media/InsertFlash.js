              ...
              _this2.props.form.validateFieldsAndScroll(function (err, values) {
                if (!err) {
                  ...
                  if (_this2.state.entityKey) {
                    var newContentState = contentState.replaceEntityData(_this2.state.entityKey, values);
                    ...
                    var contentStateWithEntity = contentState.createEntity('flash', 'IMMUTABLE', values);
