...
var FocusEditor = function (_React$Component) {
  ...
  _createClass(FocusEditor, null, [{
    ...
    value: function toHTML(contentState) {
      var nonBreakingContentState = _draftJs.ContentState.createFromBlockArray(contentState.getBlocksAsArray().map(function (block) {
        return block.update('text', function (text) {
      ...
      var html = (0, _draftConvert.convertToHTML)({
        ...
        blockToHTML: function blockToHTML(block) {
          ...
          if (block.type === 'header-one') {
            return _react2.default.createElement('h1', { style: { textAlign: textAlign } });
          }
          if (block.type === 'header-two') {
            return _react2.default.createElement('h2', { style: { textAlign: textAlign } });
          }
          if (block.type === 'header-three') {
            return _react2.default.createElement('h3', { style: { textAlign: textAlign } });
          }
          if (block.type === 'header-four') {
            return _react2.default.createElement('h4', { style: { textAlign: textAlign } });
          }
          if (block.type === 'header-five') {
            return _react2.default.createElement('h5', { style: { textAlign: textAlign } });
          }
          if (block.type === 'header-six') {
            return _react2.default.createElement('h6', { style: { textAlign: textAlign } });
          }
  ...
  function FocusEditor(props) {
    ...
    _this.blockRendererFn = function (contentBlock) {
      ...
      var onSelect = function onSelect(key) {
        ...
        _this.onChange(_draftJs.EditorState.acceptSelection(editorState, selection));
      };
